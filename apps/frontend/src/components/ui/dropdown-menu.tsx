...
const itemClassName =
  'relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-2 text-base ' +
...
>(function DropdownMenuItem({ className, ...props }, ref) {
  return <DropdownMenuPrimitive.Item ref={ref} className={cn(itemClassName, className)} {...props} />;
});
...
>(function DropdownMenuRadioItem({ className, children, ...props }, ref) {
  return (
    ...
    >
      ...
      <span className="absolute right-2 flex size-4 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <Circle className="size-2 fill-current text-primary-ink" aria-hidden="true" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
    </DropdownMenuPrimitive.RadioItem>
  );
...
>(function DropdownMenuLabel({ className, ...props }, ref) {
  return (
    <DropdownMenuPrimitive.Label
      ref={ref}
      className={cn('px-2 py-1.5 font-display text-micro font-semibold uppercase text-muted-foreground', className)}
      {...props}
    />
  );
});
